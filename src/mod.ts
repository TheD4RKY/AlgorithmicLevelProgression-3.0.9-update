import { IPreDBLoadMod } from "./../types/models/external/IPreDBLoadMod.d";
...
class AlgorithmicLevelProgression implements IPreDBLoadMod, IPostDBLoadMod {
  preDBLoad(container: DependencyContainer): void {
